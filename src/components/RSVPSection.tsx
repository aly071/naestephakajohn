          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <RadioGroup defaultValue="yes" name="entry.877086558" className="flex gap-6">
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="yes" id="attending-yes" />
                    <Label htmlFor="attending-yes" className="font-sans cursor-pointer">Joyfully Accept</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="no" id="attending-no" />
                    <Label htmlFor="attending-no" className="font-sans cursor-pointer">Regretfully Decline</Label>
                  </div>
                </RadioGroup>
              </div>

              <div className="space-y-2">
                <Label htmlFor="guests" className="font-sans text-sm">Number of Guests</Label>
                <Input
                  id="guests"
